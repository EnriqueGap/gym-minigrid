...
register(
    id='MiniGrid-T-9x9HN-v0',
    entry_point='gym_minigrid.envs:TEnv9x9HN'
)
...
class TEnv15x15HN(TEnvHN):
    def __init__(self, **kwargs):
        super().__init__(size=15,**kwargs)
register(
    id='MiniGrid-T-15x15HN-v0',
    entry_point='gym_minigrid.envs:TEnv15x15HN'
)
class TEnv27x27HN(TEnvHN):
    def __init__(self, **kwargs):
        super().__init__(size=27,**kwargs)
register(
    id='MiniGrid-T-27x27HN-v0',
    entry_point='gym_minigrid.envs:TEnv27x27HN'
)
