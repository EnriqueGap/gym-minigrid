...
class TEnvML(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        # LowGoal()
        # Goalnt()
        self.put_obj(MidGoal(),width-2, height-2)  #right highest reward
...
register(
    id='MiniGrid-T-9x9ML-v0',
    entry_point='gym_minigrid.envs:TEnv9x9ML'
)
...
class TEnv15x15ML(TEnvML):
    def __init__(self, **kwargs):
        super().__init__(size=15,**kwargs)
register(
    id='MiniGrid-T-15x15ML-v0',
    entry_point='gym_minigrid.envs:TEnv15x15ML'
)
class TEnv27x27ML(TEnvML):
    def __init__(self, **kwargs):
        super().__init__(size=27,**kwargs)
register(
    id='MiniGrid-T-27x27ML-v0',
    entry_point='gym_minigrid.envs:TEnv27x27ML'
)
