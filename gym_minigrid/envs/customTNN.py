...
class TEnvNN(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        # LowGoal()
        # Goalnt()
        self.put_obj(Goalnt(),width-2, height-2)  #right highest reward
...
register(
    id='MiniGrid-T-9x9NN-v0',
    entry_point='gym_minigrid.envs:TEnv9x9NN'
)
...
class TEnv15x15NN(TEnvNN):
    def __init__(self, **kwargs):
        super().__init__(size=15,**kwargs)
register(
    id='MiniGrid-T-15x15NN-v0',
    entry_point='gym_minigrid.envs:TEnv15x15NN'
)
class TEnv27x27NN(TEnvNN):
    def __init__(self, **kwargs):
        super().__init__(size=27,**kwargs)
register(
    id='MiniGrid-T-27x27NN-v0',
    entry_point='gym_minigrid.envs:TEnv27x27NN'
)
