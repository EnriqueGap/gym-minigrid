...
class TEnvMH(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        self.put_obj(MidGoal(),1, height-2)          #left lowest/negative reward
        #=============================================================
        # Place the agent
...
register(
    id='MiniGrid-T-9x9MH-v0',
    entry_point='gym_minigrid.envs:TEnv9x9MH'
)
...
class TEnv15x15MH(TEnvMH):
    def __init__(self, **kwargs):
        super().__init__(size=15,**kwargs)
register(
    id='MiniGrid-T-15x15MH-v0',
    entry_point='gym_minigrid.envs:TEnv15x15MH'
)
class TEnv27x27MH(TEnvMH):
    def __init__(self, **kwargs):
        super().__init__(size=27,**kwargs)
register(
    id='MiniGrid-T-27x27MH-v0',
    entry_point='gym_minigrid.envs:TEnv27x27MH'
)
