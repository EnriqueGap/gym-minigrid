...
class TEnvHH(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        self.put_obj(HighGoal(),1, height-2)          #left lowest/negative reward
        #=============================================================
        # Place the agent
...
register(
    id='MiniGrid-T-9x9HH-v0',
    entry_point='gym_minigrid.envs:TEnv9x9HH'
)
...
class TEnv15x15HH(TEnvHH):
    def __init__(self, **kwargs):
        super().__init__(size=15,**kwargs)
register(
    id='MiniGrid-T-15x15HH-v0',
    entry_point='gym_minigrid.envs:TEnv15x15HH'
)
class TEnv27x27HH(TEnvHH):
    def __init__(self, **kwargs):
        super().__init__(size=27,**kwargs)
register(
    id='MiniGrid-T-27x27HH-v0',
    entry_point='gym_minigrid.envs:TEnv27x27HH'
)
