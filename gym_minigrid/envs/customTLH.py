...
register(
    id='MiniGrid-T-9x9LH-v0',
    entry_point='gym_minigrid.envs:TEnv9x9LH'
)
...
class TEnv15x15LH(TEnvLH):
    def __init__(self, **kwargs):
        super().__init__(size=15,**kwargs)
register(
    id='MiniGrid-T-15x15LH-v0',
    entry_point='gym_minigrid.envs:TEnv15x15LH'
)
class TEnv27x27LH(TEnvLH):
    def __init__(self, **kwargs):
        super().__init__(size=27,**kwargs)
register(
    id='MiniGrid-T-27x27LH-v0',
    entry_point='gym_minigrid.envs:TEnv27x27LH'
)
